# Port Fairy 15-minute WGS84 and animation update
...
This update:
- keeps the 20 m grid and changes the simulation to 15 minutes;
...
- enables R gifski in the Docker image and changes the image tag to v5.
